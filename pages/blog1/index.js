...
import { CalendarIcon, ChevronDownIcon, MapPinIcon, ClockIcon, CurrencyRupeeIcon, TruckIcon } from '@heroicons/react/20/solid';
...
const ComponentName = (props) => {
  ...
  const destinations = ['Bali', 'Manali', 'Dubai', 'Thailand', 'Maldives', 'Goa', 'Karnataka', 'Leh', 'Kerala', 'Andaman'];
  ...
  const handleMinChange = (e) => {
    ...
    setPriceRange((prev) => ({
      ...prev,
      min: value < 0 ? 0 : value > prev.max ? prev.max : value,
    }));
  };
        ...
        <BlogLayout catg={"Blog"}>
          <div className='xl:px-32 lg:px-12 flex flex-col items-center helvetica-font'>
            ...
            <div className='px-2'>
              ...
              <div className="bg-gradient-to-r from-gray-100 to-blue-100 p-6 rounded-3xl shadow-xl w-full max-w-6xl mx-auto grid grid-cols-2 lg:flex   items-center gap-4">
                {/* Destination */}
                <div className="w-full md:w-1/4">
                  <label className="text-sm text-gray-600 mb-1 block font-bold">Destination</label>
                ...
                {/* Duration */}
                <div className="w-full md:w-1/4">
                  <label className="text-sm text-gray-600 mb-1 block font-bold">Duration</label>
                ...
                {/* Date Picker */}
                <div className="w-full md:w-1/4">
                  <label className="text-sm text-gray-600 mb-1 block font-bold">Start Date</label>
                  <div className="relative">
                    <input
                      type="date"
                      value={selectedDate || ''}
                ...
                <div className="w-full md:w-1/4">
                  <label className="text-sm text-gray-600 mb-1 block font-bold">End Date</label>
                  <div className="relative">
                    <input
                      type="date"
                      value={selectedDate || ''}
                ...
                <div className="w-fit">
                  <label className="text-sm text-gray-600 mb-1 block font-bold pb-1">Price Range (₹)</label>
                  <div className="flex items-center gap-x-6">
                    <div className="relative w-1/2">
                      <CurrencyRupeeIcon className="w-8 h-4 absolute left-2 top-1/2 transform -translate-y-1/2 text-blue-400" />
                      <input
                        type="number"
                        value={priceRange.min}
                        onChange={handleMinChange}
                        className="w-28 bg-white border border-gray-200 rounded-xl py-2 pl-9 pr-2 shadow-sm focus:ring-2 focus:ring-blue-500 focus:outline-none text-sm"
                        min={0}
                      />
                    </div>
