...
function SevaDarshanam({ data }) {
    const sevaList = td['kanaka-durga-temple'][0].sevas
                ...
                <main className="flex-1 p-6">
                    <div className="flex flex-col lg:flex-row gap-6 items-start">
                        ...
                        <div className="w-full lg:w-2/3 bg-white rounded-lg shadow p-6">
                            ...
                            {activeTab === 'places' && <PlacesToVisit data={td['kanaka-durga-temple'][0].placesToVisit} />}
