    ...
    return (
        <div className="max-w-5xl mx-auto px-4 py-8">
            <h1 className="text-4xl font-bold text-center  text-[#A94A4A] mb-4">
                Hyderabad to  Vizag, Kanaka Mahalakshmi Temple Itinerary
            </h1>
...
const sevaList = [
    { name: ' VIP Darshan per person', price: 500 },
    { name: 'standard Special Darshan per person', price: 300 },
    { name: 'Ksheerabhishekam (Fridays @ 8 AM) per person', price: 200 },
    { name: 'Samuhika Ashtothara Kumkumarchana per person', price: 50 },
    { name: 'Panchamruthabhishekam (Couple)', price: 516 },
    { name: 'Kesakhandan per person', price: 10 },
    { name: 'Margasiramasa Special Darshan', price: 200 },
];
                ...
                {sevaList.map((seva, index) => (
                    <li key={index} className="border-2 border-gray-100 shadow-md rounded-lg p-4">
                        <div className="flex flex-col items-center gap-y-4 w-[280px]">
                            <span className="text-md font-medium capitalize">{seva.name}</span>
                ...
                <main className="flex lg:px-20 p-6">
                    <div className="flex flex-col lg:flex-row gap-6 items-start">
                        <div className="w-full lg:w-1/3">
                            <Image
                                src={'/temples/kanakamahalakmi.jpg'}
                                alt="Temple"
                                width={400}
                                height={400}
                                className="rounded"
