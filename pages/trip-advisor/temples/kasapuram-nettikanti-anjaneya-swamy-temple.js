...
import { CalendarDays, MapPin, Utensils, Mountain, HelpCircle } from 'lucide-react'
  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-lg text-gray-800 leading-relaxed">
        Kasapuram Nettikanti Anjaneya Swamy Temple is a famous and powerful Hanuman temple located near Guntakal in Andhra Pradesh. Devotees believe that Lord Hanuman here listens to their prayers and removes problems from their lives. The temple is known for its special poojas and vibrant Saturdays, when many people visit to seek blessings. It has a peaceful and spiritual vibe, and the idol of Lord Hanuman is said to be very old and full of divine energy. Many devotees walk barefoot to the temple to show their devotion. It's a must-visit place for Hanuman followers.
      </p>
      <div className="grid grid-cols-2 gap-4">
        <div className="p-4 bg-[#A94A4A] text-white rounded shadow capitalize">
          <h4 className="font-semibold">Highlight</h4>
          <p className="capitalize">Kasapuram Nettikanti Anjaneya Swamy Temple</p>
        </div>
        <div className="p-4 bg-[#A94A4A] rounded text-white shadow">
          <h4 className="font-semibold">District</h4>
          <p>Guntakal , Andhra Pradesh</p>
        </div>
      </div>
    </div>
  );
...
function ItinerarySelector() {
  const itinerary = {
    '1': {
      title: '1‑Day Temple Road Trip',
      subtitle: 'Hyderabad → Kasapuram',
      days: [
        {
          title: 'Same Day Return Plan',
          steps: [
            { type: 'travel', text: 'Start from Hyderabad at 5:00 AM by car.' },
            { type: 'food', text: 'Breakfast stop at Food Pyramid, Kurnool by 7:30 AM.' },
            { type: 'explore', text: 'Visit Gooty Fort and explore till 10:30 AM.' },
            { type: 'temple', text: 'Reach Kasapuram Netti Kanti Anjaneya Swamy Temple by 12:30 PM.' },
            { type: 'food', text: 'Lunch at Masala Udupi, Guntakal around 2:00 PM.' },
            { type: 'travel', text: 'Start return journey by 4:00 PM.' },
            { type: 'food', text: 'Dinner stop at Blue Moon Dhaba near Kurnool by 7:30 PM.' },
    ...
    '3': {
      ...
      subtitle: 'Hyderabad → Kasapuram via Kurnool',
      days: [
        {
          title: 'Day 1: Hyderabad → Kurnool',
          steps: [
            { type: 'travel', text: 'Leave Hyderabad at 7:00 AM.' },
            { type: 'food', text: 'Breakfast at 7 Food Court near Jadcherla by 8:30 AM.' },
            { type: 'explore', text: 'Explore Oravakallu Rock Garden near Kurnool by 11:00 AM.' },
            { type: 'food', text: 'Lunch at Suruchi Restaurant, Kurnool by 1:00 PM.' },
            { type: 'travel', text: 'Check-in to hotel and rest.' },
            { type: 'explore', text: 'Evening visit to Konda Reddy Fort and dinner at RR Family Restaurant.' }
          ]
        },
        {
          title: 'Day 2: Kurnool → Kasapuram → Gooty',
          steps: [
            { type: 'food', text: 'Early breakfast at hotel and leave by 7:30 AM.' },
            { type: 'temple', text: 'Darshan at Kasapuram Temple by 10:00 AM.' },
            { type: 'explore', text: 'Explore Gooty Fort till 2:00 PM.' },
            { type: 'food', text: 'Lunch at Sri Sai Hotel, Guntakal around 2:30 PM.' },
            { type: 'travel', text: 'Drive back to Kurnool, dinner at Green Leaf Restaurant.' }
          ]
        },
        {
          title: 'Day 3: Return to Hyderabad',
          steps: [
            { type: 'food', text: 'Breakfast at 7:30 AM and checkout.' },
            { type: 'explore', text: 'Optional stop at Belum Caves by 10:30 AM.' },
            { type: 'food', text: 'Lunch at Haritha Hotel, Orvakal around 1:30 PM.' },
            { type: 'travel', text: 'Short tea break at Hill View Dhaba and reach Hyderabad by 6:00 PM.' }
          ]
        }
      ]
    }
  ...
  return (
    <div className="max-w-5xl mx-auto px-4 py-8">
      <h1 className="text-4xl font-bold text-center  text-[#A94A4A] mb-4">
        Hyderabad to Kasapuram Itinerary
      </h1>
...
const sevaList = [
  { name: 'Athi Sheegra Darshanam (అతి శీఘ్ర దర్శనం)', price: 100 },
  { name: 'Mukhamandapa Darshanam (ముఖమండప దర్శనం)', price: 100 },
  { name: 'Nijaroopa Darshanam (నిజరూప దర్శనం)', price: 50 },
  { name: 'Sheegra Darshanam (శీఘ్ర దర్శనం)', price: 50 },
];
...
function PlacesToVisit() {
  const places = [
    "🕍 Sangala Sri Bugga Sangameswara Swamy Temple",
    "🏞️ Orvakal Rock Garden",
    "🛕 Pennaahobilam Narasimha Swamy Temple",
    "🏛️ Tadipatri Temples"
  ];
...
function FAQ() {
  ...
  const faqs = [
    {
      question: "Where is Kasapuram Nettikanti Anjaneya Swamy Temple located?",
      answer:
        "The temple is located in Kasapuram village, near Guntakal town in Anantapur district, Andhra Pradesh.",
    },
    {
      question: "What is the best time to visit the temple?",
      answer:
        "Saturdays are considered very auspicious, and many devotees visit on this day. The Hanuman Jayanti festival is also celebrated grandly here.",
    },
    {
      question: "Are there any special poojas or rituals at the temple?",
      answer:
        "Yes, special poojas, abhishekams, and sevas are performed regularly. Devotees also offer coconuts and perform pradakshinas (circumambulations).",
    },
    {
      question: "Is accommodation available near the temple?",
      answer:
        "Yes, there are a few lodges and guest houses in Guntakal, which is just a few kilometres away from the temple.",
    }
  ];
