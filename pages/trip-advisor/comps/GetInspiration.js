        ...
        <div className='py-4 px-4 lg:py-10'>
            ...
            <div className='flex flex-col lg:flex-row gap-4 pt-10'>
                <div className='flex flex-col gap-2'>
                    <img src="https://templearchitectvkt.com/images/Side%20View__cam_04_01.jpg" alt="Travel Article" className="w-full h-60 lg:w-60 object-cover object-bottom rounded-lg" />
                    <p className='text-lg font-semibold'>Top 10 temples in india</p>
                    <p>Jan, 11 2023</p>
                </div>
                <div className='flex flex-col gap-2'>
                    <img src="/keralashot.jpg" alt="Travel Article" className=" h-60 w-full lg:w-60 object-cover object-bottom rounded-lg" />
