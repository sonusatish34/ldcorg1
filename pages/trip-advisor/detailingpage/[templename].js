...
// import UserDropdown from "../temples/detailing-page/comp/UserDropDown";
// import { CalendarDays, MapPin, Utensils, Mountain } from 'lucide-react'


// function TempleInfo({ name }) {
//     const templeData = Array.isArray(td?.[name]) ? td[name][0] : null;
...
//     return (
//         <div className="pt-4">
//             <div className="space-y-2 py-6 bg-white rounded-md p-2">
//                 <h3 className="text-xl font-semibold text-[#A94A4A]">Nearby Attractions</h3>
//                 <ul className="text-gray-700 list-inside list-square flex flex-col gap-y-1">
//                     {places.map((place, i) => (
//                         <li className="list-disc" key={i}>{place.trim()}</li>
//                     ))}
//                 </ul>
//             </div>
//         </div>
...
//                             <Image
//                                 src={templeData?.image || "/placeholder.jpg"}
//                                 alt="Temple"
//                                 width={400}
//                                 height={400}
//                                 className="rounded"
...
//                             <Facilities name={templateName} />
//                             <PlacesToVisit name={templateName} />
//                         </div>
